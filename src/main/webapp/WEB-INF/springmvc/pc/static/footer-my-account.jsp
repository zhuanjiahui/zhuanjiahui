        ...
        <div class="footer-sub">
            ...
            <div class="footer-sub-right">
                ...
                <div class="join-section">
                    <h2>（一）注册登录</h2>
                    <dl>
                        <dt>1. 怎样注册成为专家汇的助理？</dt>
                        <dd>点击网站首页的“免费注册”，选择“用户注册”，填写如下页面信息，根据提示完成注册。专家汇提供手机注册方式。</dd>
                        <br />
                        <dd><img src="/images/footer-register.png" alt="注册图片"></dd>
                    </dl>
                    <br />
                    <br />
                    <dl>
                        <dt>2. 我已经有专家汇的账号，如何登录呢？</dt>
                        <dd>通过网站首页的登录按钮进入到登录页面，输入手机号及密码即可进行登录。</dd>
                    </dl>
                </div>
                <div class="join-section">
                    <h2>（二）变更密码</h2>
                    <dl>
                        <dt>1. 忘记密码怎么办？</dt>
                        <dd>可以在登录页面点击“忘记密码”，然后依据提示输入手机号码、短信校验码、新密码即可。</dd>
                    </dl>
                    <br />
                    <br />
                    <dl>
                        <dt>2. 怎样修改密码？</dt>
                        <dd>可以在个人中心设置里，在“重置密码”一栏中，输入新密码，点击保存。</dd>
                        <br />
                        <dd><img src="/images/footer-password.png" alt="我的帐号页修改密码"></dd>
                    </dl>
                </div>
            </div>
        </div>
