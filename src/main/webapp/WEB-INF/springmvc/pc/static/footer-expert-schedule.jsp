        ...
        <div class="footer-sub">
            ...
            <div class="footer-sub-right">
                ...
                <div class="join-section">
                    ...
                    <dl>
                        <dt>1. 如何进行档期设置？</dt>
                        <dd>进入到您的个人中心，点击“档期管理“出现日历，根据您的时间安排单击每个日期设定状态，设置分为可约、不可约。（黑色已支付订单的日期不可设定）</dd>
                        <br />
                        <dd><img src="/images/footer-schedule.png" alt="档期管理"></dd>
                    </dl>
                    <br />
                    <br />
                    <dl>
                        <dt>2. 最多可以设定未来多久的时间，黑色已支付订单下地址是什么意思？</dt>
                        <dd>目前专家汇统一规定的档期设定时间为一年，也就说您能设定未来一年内的时间；黑色已支付订单下地址代表是您将要去服务的地址。</dd>
                        <br />
                        <dd><img src="/images/footer-schedule.png" alt="档期管理"></dd>
                    </dl>
                </div>
                <div class="join-section">
                    <h2>（二）行程安排</h2>
                    <dl>
                        <dt>1. 在档期管理中看到选定日期的行程安排？</dt>
                        <dd>点击黑色已支付订单“当期管理“下方会出现选定日期的订单信息，您可以根据日期方便查找行程。</dd>
                        <br />
                        <dd><img src="/images/footer-order.png" alt="档期管理"></dd>
                    </dl>
                </div>
            </div>
        </div>
