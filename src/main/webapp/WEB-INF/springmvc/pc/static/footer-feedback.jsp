    ...
    <div class="wrap0">
        ...
        <div class="footer-sub">
            ...
            <ul class="footer-sub-left">
                ...
                <a href="/pc/static/footer-feedback"><li class="footer-sub-2-but footer-sub-2s">意见反馈
                    <div class="right-arrow">></div>
                </li></a>
            </ul>
            <!-- 右边部分 -->
            <div class="footer-sub-right">
                <h1>意见反馈</h1>
                <textarea class="footer-sub-right-text" placeholder="有什么建议，您提出来我们解决"></textarea>
                <input class="footer-sub-right-text2" placeholder="QQ / 邮箱 / 手机">
                <button class="feedback-but">提交</button>
            </div>
        </div>
    </div>
    </div>
