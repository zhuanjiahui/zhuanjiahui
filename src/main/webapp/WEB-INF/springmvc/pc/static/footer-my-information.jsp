        ...
        <div class="footer-sub">
            ...
            <div class="footer-sub-right">
                ...
                <div class="join-section">
                    <h2>（一）完善资料</h2>
                    <dl>
                        <dt>1. 专家需要完成哪些条件才能被搜索到？</dt>
                        <dd>只有专家的个人资料设置完整、身份认证通过、服务已设置的情况下，才可以被搜索到。</dd>
                    </dl>
                    <br />
                    <br />
                    <dl>
                    ...
                    <br />
                    <dl>
                        <dt>3. 我刚开始是在职，后来离职专门做培训专家，个人资料公司职务怎么办？</dt>
                        <dd>您可以根据您的实际情况，在公司名称和自由职业中选填一项，根据您的描述您完全可以在自由职业中选择培训讲师填写。</dd>
                    </dl>
                </div>
                <div class="join-section">
                    <h2>（二）专家认证</h2>
                    <dl>
                        <dt>1. 专家认证都需要提供哪些资料？</dt>
                        <dd>身份证认证是必须提供的信息；除此之外，为了提高平台专家的公信力，鼓励老师上传专家学历认证等证书信息；专家承诺会严格保密认证信息。</dd>
                    </dl>
                </div>
            </div>
        </div>
