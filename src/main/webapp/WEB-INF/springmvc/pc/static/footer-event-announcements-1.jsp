    ...
    <div class="wrap0">
        ...
        <div class="footer-sub">
            ...
            <div class="footer-sub-right">
                <h1>活动公告</h1>
                <p>专家汇创业沙龙嘉宾分享  2014年11月</p>
                <p>活动举办时间:11月7号（星期六）下午13:30</p>
                <p>活动主题:【专家汇O2O篇】专家汇创业沙龙嘉宾分享 </p>
                <p>活动地点:专家汇总部</p>
                <p>主办单位:专家汇</p>
                <p>活动规模:50</p>
                <p>活动嘉宾:资深创业者及投资机构</p>
                <p>活动内容:</p>
                <p>本次活动以创业分享为主题，专家汇诚邀创业资深人士与到场嘉宾分享实战经验，为各位创业人士以后发展管理企业提供参考借鉴。同</p>
                <p>时，更有知名投资机构专业人士莅临活动现场。邀请嘉宾: 精一天使李汉生、联创投资合伙人李刚强、健乐通创始人文皓、微微拼车总</p>
                <p>邀请嘉宾: 差旅报销CEO肖宁、神州数码雷鸣、为知笔记副总裁刘晓攀、多盟王云鹏、御银股份副董事长高永坚、北京圣世通信CEO张</p>
                <p>经理蒲繁强 、差旅报销CEO肖宁、天天投崔鹏、云子袁晓飞、专家汇联合创始人邓博、联想渠道总监陈刚。</p>
                ...
                <table border="1px" class="event-table">
                    ...
                    <tr>
                        ...
                        <td class="event-td">c差旅报销肖宁</td>
                    </tr>
                    <tr>
                        <td class="event-td">14:30 - 14:50</td>
                        <td class="event-td">联想陈刚</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="event-td">专家汇展示环节</td>
                    </tr>
                    <tr>
                        <td class="event-td">15:40 - 16:00</td>
                        <td class="event-td">精一天使李汉生</td>
                    </tr>
                    <tr>
                        <td class="event-td">16:00 - 16:20</td>
                        <td class="event-td">微微拼车创始人兼 CEO 蒲繁强</td>
                    </tr>
                    <tr>
