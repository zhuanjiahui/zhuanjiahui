 ...
 * 分页列表（1,2,3...）
 */
public class PageList extends BodyTagSupport {
    ...
    private String getPagesUrl(int index, int pageCount, StringBuilder pageHref) {
        ...
        content.append("<ul class=\"page-ul\">");
        ...
        if (pageCount <= DISPLAY_PAGES) {//总页数小于指定页数，则展示所有分页
            ...
            if (index - 1 <= distance) {//当前页距离首页近时，这之间不用省略号  呈现样式1234567...10 假设pageCount为10
                ...
                content.append("<li class=\"page-li\"><a href=\"#\">").append("...</a></li>");
                content.append("<li class=\"page-li\"><a href=\"").append(pageHref).append(pageCount).append("\">").append(pageCount).append("</a></li>");
            } else if (pageCount - index <= distance) {//当前页尾页近时，这之间不用省略号 呈现样式1...456789 10
                content.append("<li class=\"page-li\"><a href=\"").append(pageHref).append(1).append("\">").append(1).append("</a></li>");
                content.append("<li class=\"page-li\"><a href=\"#\">").append("...</a></li>");
    ...
    private StringBuilder getDisplayPages(int index, int beginIndex, int endIndex, StringBuilder pageHref) {
        ...
        for (int i = beginIndex; i <= endIndex; ++i) {
            if (i == index) {//当前页 不能重复访问
                content.append("<li class=\"page-li\"><a href=\"#\" class=\"page-current\">").append(i).append("</a></li>");
            } else {
                content.append("<li class=\"page-li\"><a href=\"").append(pageHref).append(i).append("\">").append(i).append("</a></li>");
            }
        }
        return content;
    }
    ...
    private String getPrePage(int index, StringBuilder pageHref) {
        ...
        if (preIndex <= 0) {
            return "<li class=\"page-li page-disabled\"><a href=\"#\">&laquo;</a></li>";
        } else {
            return new StringBuilder("<li class=\"page-li\"><a href=\"").append(pageHref).append(preIndex).append("\">&laquo;</a></li>").toString();
        }
    }
    ...
    private String getNextPage(int index, int pageCount, StringBuilder pageHref) {
        ...
        if (nextIndex > pageCount) {
            return "<li class=\"page-li page-disabled\"><a href=\"#\">&raquo;</a></li>";
        } else {
            return new StringBuilder("<li class=\"page-li\"><a href=\"").append(pageHref).append(nextIndex).append("\">&raquo;</a></li>").toString();
        }
    }
